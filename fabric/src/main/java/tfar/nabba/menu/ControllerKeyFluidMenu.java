...
public class ControllerKeyFluidMenu extends SearchableFluidMenu<SearchableFluidHandler> {



    public ControllerKeyFluidMenu(int pContainerId, Inventory inventory, ContainerLevelAccess pAccess, SearchableFluidHandler controllerHandler, ContainerData inventoryData, ContainerData syncSlots) {
    ...
    protected ControllerKeyFluidMenu(@Nullable MenuType<?> pMenuType, int pContainerId, Inventory inventory, ContainerLevelAccess access, SearchableFluidHandler controllerHandler, ContainerData
