...
public class ControllerKeyItemMenu extends SearchableItemMenu<SearchableItemHandler> {



    public ControllerKeyItemMenu(int pContainerId, Inventory inventory, ContainerLevelAccess pAccess, SearchableItemHandler controllerHandler, ContainerData inventoryData, ContainerData syncSlots) {
    ...
    protected ControllerKeyItemMenu(@Nullable MenuType<?> pMenuType, int pContainerId, Inventory inventory, ContainerLevelAccess access, SearchableItemHandler controllerHandler, ContainerData
