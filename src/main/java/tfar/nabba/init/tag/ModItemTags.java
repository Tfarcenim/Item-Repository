...
public class ModItemTags {
    public static final TagKey<Item> BARRELS = ItemTags.create(new ResourceLocation(NABBA.MODID,"barrels"));
    ...
    public static final TagKey<Item> FLUID_BARRELS = ItemTags.create(new ResourceLocation(NABBA.MODID,"fluid_barrels"));
