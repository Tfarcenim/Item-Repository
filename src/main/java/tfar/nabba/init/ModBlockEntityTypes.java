...
public class ModBlockEntityTypes {
    ...
    public static final BlockEntityType<AntiBarrelBlockEntity> ANTI_BARREL = BlockEntityType.Builder.of(AntiBarrelBlockEntity::new,ModBlocks.ANTI_BARREL).build(null);
