...
import static tfar.nabba.util.ForgeUtils.*;

public enum Upgrades implements Upgrade {
    DUMMY(0,NOTHING,() -> Items.AIR),
    STORAGE(1, ForgeUtils.add_to_internal_upgrades,1,() -> ModItems.BETTER_BARREL_STORAGE_UPGRADE,64000,NOTHING),
    ...
    VOID(1, ForgeUtils.apply_void,() -> ModItems.VOID_UPGRADE,1),
    PICKUP(8, ForgeUtils.add_to_internal_upgrades,() -> ModItems.PICKUP_1x1_UPGRADE,9, PICKUP_TICK),
