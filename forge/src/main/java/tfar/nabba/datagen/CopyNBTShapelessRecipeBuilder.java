...
public class CopyNBTShapelessRecipeBuilder extends ShapelessRecipeBuilder {
    ...
    public void save(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ResourceLocation pRecipeId) {
        ...
        pFinishedRecipeConsumer.accept(new Result(pRecipeId, this.getResult(), this.count, this.group == null ? "" : this.group, determineBookCategory(category),this.ingredients, this.advancement,
